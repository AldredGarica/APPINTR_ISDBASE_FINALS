    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        if(action.isLoginAccepted() == true) {
            String myvar = "<html lang=\"en\"><head>" +
                    ...
                    "        <form method=\"post\" class=\"login100-form\" action=\"process.PerformAddGuitarAction\">" +
                    ...
                    "            </div>" +
                    "<hr>" +
                    "        </form><form method=\"post\" class=\"login100-form\" action=\"process.PerformRemoveGuitarAction\">" +
