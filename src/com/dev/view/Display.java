...
public class Display extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        String myvar = "<html lang=\"en\"><head>"+
                ...
                "        <form method=\"post\" class=\"login100-form validate-form\" action=\"process.PerformDatabaseAction\">"+
                ...
                "                    <input class=\"input100\" type=\"text\" name=\"username\" placeholder=\"Enter Guitar Name\">"+
                "                    <span class=\"focus-input100\"></span>"+
                "                </div>"+
                "                <div class=\"wrap-input100 validate-input m-b-20\" data-validate=\"Enter Guitar Price\">"+
                "                    <input class=\"input100\" type=\"text\" name=\"password\" placeholder=\"Enter Guitar Price\">"+
                "                    <span class=\"focus-input100\"></span>"+
                "                </div>"+
                ""+
