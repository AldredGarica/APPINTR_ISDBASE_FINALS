...
public class errorDisplay extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.print("<form class=\"login100-form validate-form\" action=\"index.jsp\">");
        out.print("<span class=\"login100-form-title p-b-37\">Error Page</span>");
        out.print("<center><font size=\"+1.8\"><p>Incorrect Login OR Unidentified Error Occurred</font></p></center>");
